...
{
	public class P1Condition : BaseCondition
	{
		public static void SerializeBaseCondition(Stream output, Endian endianess, BaseCondition condition)
		{
			...
			condition.SerializeProperties(PrototypeGame.P1, output, endianess);
		...
		{
			BaseCondition obj = Factory<BaseCondition, KnownConditionAttribute>.Build(PrototypeGame.P1, hash) ?? throw new NotImplementedException("Unknown condition");
