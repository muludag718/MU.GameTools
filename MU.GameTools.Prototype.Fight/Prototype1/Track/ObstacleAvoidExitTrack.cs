...
namespace MU.GameTools.Prototype.Fight.Prototype1.Track
{
	...
	[KnownTrack(TrackHash.ObstacleAvoidExit)]
	public class ObstacleAvoidExitTrack : P1Track
	{
		...
		public override void Serialize(Stream output, Endian endianess)
		{
			...
			output.WriteValueF32(TangentDistance, endianess);
			output.WriteValueF32(NormalDistance, endianess);
		...
		public override void Deserialize(Stream input, Endian endianess)
		{
			...
			TangentDistance = input.ReadValueF32(endianess);
			NormalDistance = input.ReadValueF32(endianess);
