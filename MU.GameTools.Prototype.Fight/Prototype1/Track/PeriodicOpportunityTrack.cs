...
{
	[KnownTrack(TrackHash.PeriodicOpportunity)]
	public class PeriodicOpportunityTrack : P1Track
	{
		public float TimeBegin { get; set; }

		public float TimeEnd { get; set; }

		public float TimeHook { get; set; }
		...
		public override void Serialize(Stream output, Endian endianess)
		{
			...
			output.WriteValueF32(TimeHook, endianess);
		...
		public override void Deserialize(Stream input, Endian endianess)
		{
			...
			TimeHook = input.ReadValueF32(endianess);
