...
namespace MU.GameTools.Prototype.Fight.Prototype1.Track
{
	...
	public class HunterShortRangeLocoTrack : P1Track
	{
		...
		public override void Serialize(Stream output, Endian endianess)
		{
			...
			output.WriteValueF32(CorneringTime, endianess);
			...
			OnCorner.Serialize(output, endianess);
			output.WriteValueS32(OnCornerPriority, endianess);
		}
		...
		public override void Deserialize(Stream input, Endian endianess)
		{
			...
			CorneringTime = input.ReadValueF32(endianess);
			...
			OnCorner.Deserialize(input, endianess);
			OnCornerPriority = input.ReadValueS32(endianess);
		}

		public override void SerializeProperties(PrototypeGame game, Stream output, Endian endianess)
		{
			BaseProperty.SerializeBaseProperty(PrototypeGame.P1, output, endianess, OnCornerConditions);
		}

		public override void DeserializeProperties(PrototypeGame game, Stream input, Endian endianess)
		{
			OnCornerConditions = BaseProperty.DeserializeConditionProperty(PrototypeGame.P1, input, endianess, PropertyHash.OnCornerConditions);
		}
	}
}
