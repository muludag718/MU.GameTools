...
namespace MU.GameTools.Prototype.Fight.Prototype1.Condition
{
	...
	[KnownCondition(ConditionHash.ShootCheckAmmoCount)]
	public class ShootCheckAmmoCountCondition : P1Condition
	{
		...
		public override void Serialize(Stream output, Endian endianess)
		{
			...
			output.WriteValueS32(RequiredAmount, endianess);
		}
		...
		public override void Deserialize(Stream input, Endian endianess)
		{
			...
			RequiredAmount = input.ReadValueS32(endianess);
		}
	}
}
