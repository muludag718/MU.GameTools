...
namespace MU.GameTools.Prototype.Fight.Prototype2
{
	public class P2Track : BaseTrack
	{
		...
		{
			output.WriteValueF32(Unknown1, endianess);
			output.WriteValueU32(Unknown2, endianess);
		}

		public override void Deserialize(Stream input, Endian endianess)
		{
			Unknown1 = input.ReadValueF32(endianess);
			Unknown2 = input.ReadValueU32(endianess);
		}
		...
		{
			BaseTrack obj = Factory<BaseTrack, KnownTrackAttribute>.Build(PrototypeGame.P2, hash) ?? throw new NotImplementedException("Unknown track");
